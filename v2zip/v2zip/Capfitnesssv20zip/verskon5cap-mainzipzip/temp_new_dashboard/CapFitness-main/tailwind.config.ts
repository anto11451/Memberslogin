    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow": {
          ...
          "50%": { 
            boxShadow: "0 0 10px hsl(var(--primary)), 0 0 20px hsl(var(--primary) / 0.7), 0 0 30px hsl(var(--primary) / 0.4)"
          },
        },
      },
      animation: {
      ...
      backgroundImage: {
        ...
        "neon-gradient": "linear-gradient(135deg, hsl(var(--primary)) 0%, hsl(var(--accent)) 100%)",
      },
    },
  },
