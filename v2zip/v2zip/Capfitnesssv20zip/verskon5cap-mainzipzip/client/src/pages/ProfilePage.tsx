      ...
      if (result?.ok) {
        if (setUser && user) {
          setUser({
            ...
            currentWeight: profile.current_weight || user.currentWeight,
            calorieTarget: profile.calorie_target || user.calorieTarget,
            proteinTarget: profile.protein_target || user.proteinTarget,
          });
        }
        toast({
